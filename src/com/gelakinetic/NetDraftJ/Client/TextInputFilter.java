...
class TextInputFilter extends DocumentFilter {
    ...
    /**
     * Invoked prior to insertion of text into the specified Document. Subclasses
     * that want to conditionally allow insertion should override this and only call
     * supers implementation as necessary, or call directly into the FilterBypass.
     *
    ...
    /**
     * Validate the given text making sure it's either a valid IP address in
     * progress or username
     * 
     ...
     * Subclasses that want to conditionally allow replace should override this and
     * only call supers implementation as necessary, or call directly into the
     * FilterBypass.
     * 
     * @param fb           FilterBypass that can be used to mutate Document
     ...
     * @param attributeSet AttributeSet indicating attributes of inserted text, null
     *                     is legal.
     * @throws BadLocationException the given insert position is not a valid
     *                              position within the document
     */
     ...
     * Subclasses that want to conditionally allow removal should override this and
     * only call supers implementation as necessary, or call directly into the
     ...
     *                              valid part of the document. The location in the
