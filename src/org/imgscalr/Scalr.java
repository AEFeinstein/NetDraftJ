...
public class Scalr {
     ...
     * hints.
     * <h3>Performance</h3> Use of this (and other) {@link ConvolveOp}s are
     * hardware accelerated when possible. For more information on if your image
     * op is hardware accelerated or not, check the source code of the
     ...
     * <h3>Known Issues</h3> In all versions of Java (tested up to Java 7
     * preview Build 131), running this op against a GIF with transparency and
     * attempting to save the resulting image as a GIF results in a
     * corrupted/empty file. The file must be saved out as a PNG to maintain the
     * transparency.
     * 
     * @since 3.0
     */
